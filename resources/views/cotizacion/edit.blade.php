...
<script>
  ...
  ////---------------------------------------------------
    ...
    function establecerDatosCotizacion(Finalarray,cant,ref,desc,marca,dias,precioVentaUnitarioXItem,precioVentaTotalXItem,precioGranTotalVenta,notas_cotizacion_export){
    ...
    function listarItems(){
        ...
        Res_costoGranTotalPesosconAdc=(GranTotalEnPesosPartsImport+GranTotalCostoPesos)+parseFloat(flete_cop_calc)+parseFloat(nacionalizacion_calc)+parseFloat(transportadora_calc)+((parseFloat(flete_usd_calc)+parseFloat(comision_banco_transf_exterior_calc))*dolarRealCalc)
            ...
            establecerDatosCotizacion(Finalarray,cant,ref,desc,marca,dias,precioVentaUnitarioXItem,precioVentaTotalXItem,precioGranTotalVenta,notas_cotizacion_export);
